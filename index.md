...
To achieve this goal, it will use a heavily modified version of the [RAMSES](https://www.ics.uzh.ch/~teyssier/ramses/) hydrodynamic code with the MPI+OMP+GPU parallelism and the next-generation supercomputer at [Korea Insitute of Science and Technology Information](https://www.kisti.re.kr/eng/). 
